...
# # 求解器结果展示
create_interactive_comparison_viz(train_path="data/wave_solution_2d(32).npz",
                                  pred_path=f"result/wave/wave（005）/pgn_prediction_2d(wave_add_005_dnoise)_final.npz",
                                  interval=0.05)

# 数据集展示
# save_path="data/wave_solution_2d_noise_0.005.npz"
